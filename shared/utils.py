...
def load_json(filepath):
    try:
        ...
        info = app_logger.log_error(e, f"utils.load_json({filepath})")
        return None
...
def save_json(filepath, data):
    try:
        ...
        info = app_logger.log_error(e, f"utils.save_json({filepath})")
        return False
...
def seed_countries():
    try:
        ...
        info = app_logger.log_error(e, "utils.seed_countries")
        return []
